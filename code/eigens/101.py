...
for i in range(pm.nrns):
    for j in range(pm.nrns):
        ...
        #:::
            ...
            conn_matrix[j][i] = pm.flip(0.101,i)
...
print "% connections within a hypercolumn= ", round((count23+count4+count5+countA+countB)/float(g)*100.)
print "% connections outside a hypercolumn= ", round(float(float(countQ)/float(g))*100.)
print
#"""
