...
print "countQ = ",countQ
print "countAz = ",countAz
"""
print "connections 30%", countQ
...
print "% connections within a hypercolumn= ", round((countQ)/float(g)*100.)
